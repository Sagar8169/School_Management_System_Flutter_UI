...
class _StudentProfilePageState extends State<StudentProfilePage> {
  ...
  Color get _themeColor => _isCritical ? const Color(0xFFDC2626) : const Color(0xFF1D4ED8);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            // Top Header (Keeping your original header with navigation)
            _buildHeader(),
  ...
  // Updated Profile Header with Gradient
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.studentData['details']?.toString() ?? 'Not Specified',
                          style: const TextStyle(
                ...
                Row(
                  ...
                  children: [
                    _buildInfo("Student ID", widget.studentData['details'].toString().split('•').last.trim()),
                    _buildInfo("Roll Number", "15"),
                  ],
                ),
              ],
            ),
  ...
  // Updated Academic Performance Card
  ...
  // Updated Subject Performance List
        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () {
                  _navigateTo(PrincipalRoutes.gradesAnalytics, arguments: {
  ...
  // Keep your original bottom navigation bar
