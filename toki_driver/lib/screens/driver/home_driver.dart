      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                _buildModernTimelineItem(1, 'Banjara Hills Circle', '07:30 AM', isFirst: true, isCrossed: true),
                _buildModernTimelineItem(2, 'Jubilee Hills Checkpost', '07:45 AM', isCrossed: true),
                _buildModernTimelineItem(3, 'Road No 10 Hub', '08:00 AM', isCurrent: true),
                _buildModernTimelineItem(4, 'DPS Main School', '08:15 AM', isLast: true),
              ],
            ),
          ),
...
// Modern Timeline Item Helper
  Widget _buildModernTimelineItem(int index, String title, String time, {bool isFirst = false, bool isLast = false, bool isCrossed = false, bool isCurrent = false}) {
    Color dotColor = isCrossed ? Colors.green : (isCurrent ? const Color(0xFFE65100) : Colors.grey.shade300);
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: isCurrent ? [BoxShadow(color: dotColor.withOpacity(0.3), blurRadius: 10)] : null,
                ),
                child: isCrossed ? const Icon(Icons.check, size: 14, color: Colors.white) : null,
              ),
              if (!isLast)
                Expanded(
                  child: Container(
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isCurrent ? Colors.black : (isCrossed ? Colors.black87 : Colors.grey),
                      ),
                    ),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: isCurrent ? const Color(0xFFE65100) : Colors.grey.shade400,
                    ),
                  ),
                ],
              ),
  ...
  Widget _infoTile(IconData icon, String text) {
    return Row(
      children: [
        ...
        Text(text, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: Colors.blueGrey)),
      ],
    );
  }
