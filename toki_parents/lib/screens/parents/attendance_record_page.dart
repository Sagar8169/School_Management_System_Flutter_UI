...
class _AttendanceRecordPageState extends State<AttendanceRecordPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            ...
            colors: [_primaryGreen, const Color(0xFF059669)]),
  ...
  Widget _buildOverallTermStats() {
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
        _bigStat("180", "Working", Colors.blue),
        _bigStat("172", "Present", _textGreen),
        _bigStat("08", "Absent", _textRed)
      ]),
    );
  }
  ...
  Widget _bigStat(String v, String l, Color c) => Column(children: [
        Text(v,
            style:
                TextStyle(color: c, fontSize: 28, fontWeight: FontWeight.w900)),
        Text(l,
            style: const TextStyle(
  ...
  Widget _buildFilteredView() {
    ...
    if (_activeFilter == "Today")
      return _buildDayCard("Wednesday", "Dec 25", true);
    if (_activeFilter == "Yesterday")
      return _buildDayCard("Tuesday", "Dec 24", true);
  ...
  Widget _buildMonthlyViewList() {
    return Column(children: [
      _buildMonthCard(
          "December 2025", "100%", 25, 0, 25, _bgGreenLight, _textGreen),
      _buildMonthCard(
          "November 2025", "95.5%", 21, 1, 22, _bgGreenLight, _textGreen)
    ]);
  }

  Widget _buildMonthCard(
      String month, String perc, int p, int a, int t, Color bg, Color txt) {
    return Container(
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Container(
              ...
              child: Text(perc,
                  style: TextStyle(
                      color: txt, fontWeight: FontWeight.w900, fontSize: 14)))
        ]),
        const Divider(height: 40),
        Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
          _mStat(p.toString(), "Present", _textGreen),
          _mStat(a.toString(), "Absent", _textRed),
          _bigStat(t.toString(), "Working", Colors.blue)
        ])
      ]),
    );
  }

  Widget _mStat(String v, String l, Color c) => Column(children: [
        Text(v,
            style:
