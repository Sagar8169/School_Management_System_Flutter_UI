        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.confirmation_num_rounded, color: Color(0xFF8B5CF6), size: 24),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          ticket['id'] ?? "#TK-8821",
                          style: TextStyle(color: Colors.grey.shade400, fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 0.5),
                        ),
                        Text(
            ...
            const Padding(
              ...
              child: Text("AVAILABLE ACTIONS", style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: Color(0xFF64748B), letterSpacing: 1.2)),
            ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Icon(Icons.confirmation_number_outlined, color: Colors.white.withOpacity(0.2), size: 40),
            ],
          ),
