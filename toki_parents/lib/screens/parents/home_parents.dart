...
class _HomeParentsState extends State<HomeParents> {
                      ...
                      children: [
                        ...
                        if (activeFilter == "All" || activeFilter == "Unread")
                          _notificationTile(
                            ...
                            iconBg: const Color(0xFFD1FAE5),   // Fixed: added iconBg
                            iconColor: const Color(0xFF10B981), // Fixed: added iconColor
                        ...
                        if (activeFilter == "All" || activeFilter == "Bus")
                          _notificationTile(
                            ...
                            iconBg: const Color(0xFFFEF3C7),   // Fixed: added iconBg
                            iconColor: const Color(0xFFF59E0B), // Fixed: added iconColor
                            title: "Bus Departure",
                        ...
                        if (activeFilter == "All" || activeFilter == "Homework")
                          _notificationTile(
                            ...
                            iconBg: const Color(0xFFE0E7FF),   // Fixed: added iconBg
                            iconColor: const Color(0xFF4F46E5), // Fixed: added iconColor
  ...
  Widget _buildFilterChip(String label, bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isSelected ? [BoxShadow(color: const Color(0xFFFF5722).withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 4))] : [],
      ),
      child: Text(
        label,
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      _buildHeroStatPill("95%", "Attendance", Icons.check_circle_rounded),
                      const SizedBox(width: 12),
                      _buildHeroStatPill("A+", "Grade", Icons.stars_rounded),
                      const SizedBox(width: 12),
                      _buildHeroStatPill("03", "Tasks", Icons.assignment_rounded),
                    ],
                  ),
                ),
  ...
  Widget _buildSectionHeading(String title) {
    return Text(
      title,
      style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, letterSpacing: -0.5, color: Color(0xFF1F2937)),
    );
  }
      ...
      child: Column(
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Monthly Rate", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
  ...
  Widget _buildGradeMetric(String label, String value, IconData icon, Color color) {
    return Column(
      children: [
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildRoutePoint(Icons.directions_bus, "Sector 12", isCurrent: true),
  ...
  Widget _buildRoutePoint(IconData icon, String label, {bool isReached = false, bool isCurrent = false}) {
    Color color = isCurrent ? const Color(0xFF3B82F6) : (isReached ? Colors.green : Colors.grey.shade300);
    return Column(
      children: [
  ...
  Widget _buildBusDetail(IconData icon, String text) {
    return Row(
      children: [
        ...
        const SizedBox(width: 6),
        Text(text, style: TextStyle(color: Colors.grey.shade700, fontSize: 12, fontWeight: FontWeight.w600)),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Icon(Icons.notifications_active_outlined, size: 14, color: Colors.grey.shade400),
              const SizedBox(width: 6),
              Text(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  month,
                  style: TextStyle(fontWeight: FontWeight.w800, fontSize: 10, color: Colors.grey.shade500),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _buildPremiumTicketPill("03", "Resolved", const Color(0xFF10B981)),
              const SizedBox(width: 10),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.add_comment_rounded, size: 16, color: Color(0xFF8B5CF6)),
                ),
                const SizedBox(width: 12),
                const Expanded(
                  child: Text(
