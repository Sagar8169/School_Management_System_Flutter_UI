...
class _AddHomeworkPageState extends State<AddHomeworkPage> {
  ...
  final List<String> subjects = ['Science', 'Mathematics', 'Physics', 'Chemistry', 'Biology'];
        ...
        actions: [
          Center(
            child: TextButton(
              ...
              child: Text("Done", style: TextStyle(color: _primaryPurple, fontWeight: FontWeight.bold)),
            ),
          ),
        ],
      ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildStylishInputCard("Homework Title", "e.g. Science Project: Photosynthesis", _titleController, 1, Icons.title_rounded),
                    _buildStylishInputCard("Description", "Detail out the tasks for students...", _descriptionController, 5, Icons.description_outlined),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Text("Add Homework", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
          const Spacer(),
          GestureDetector(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Expanded(child: InkWell(onTap: () => _showPicker("Class", classes, selectedClass, (v) => setState(() => selectedClass = v)), child: _selectorTile("Class", selectedClass, Icons.school_outlined))),
              Container(width: 1, height: 40, color: Colors.grey[100]),
              Expanded(child: InkWell(onTap: () => _showPicker("Subject", subjects, selectedSubject, (v) => setState(() => selectedSubject = v)), child: _selectorTile("Subject", selectedSubject, Icons.book_outlined))),
            ],
          ),
          const Divider(height: 1),
          InkWell(
            onTap: () => _selectDueDate(context),
            child: _selectorTile("Due Date", dueDate == null ? "Select Deadline" : "${dueDate!.day}/${dueDate!.month}/${dueDate!.year}", Icons.calendar_today_outlined),
          ),
        ],
      ),
    );
  ...
  Widget _buildStylishInputCard(String label, String hint, TextEditingController controller, int lines, IconData icon) {
    return Container(
        ...
        children: [
          Row(
            children: [
              ...
              Text(label.toUpperCase(), style: TextStyle(color: Colors.grey.shade500, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1.0)),
            ],
          ),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: TextStyle(color: Colors.grey.shade300, fontSize: 14, fontWeight: FontWeight.w400),
  ...
  Widget _buildAttachmentCard() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("ATTACHMENTS (OPTIONAL)", style: TextStyle(color: Colors.grey, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1)),
  ...
  Widget _attachBtn(IconData i, String l) => Expanded(
    child: Column(children: [
      CircleAvatar(backgroundColor: _bgLight, child: Icon(i, color: _primaryPurple, size: 20)),
      const SizedBox(height: 6),
      Text(l, style: const TextStyle(fontSize: 11, color: Colors.grey, fontWeight: FontWeight.w600)),
    ]),
  );
  ...
  Widget _buildAssignButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(backgroundColor: _primaryPurple, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18)), elevation: 4, shadowColor: _primaryPurple.withOpacity(0.4)),
        child: const Text('Assign Homework', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
      ),
    );
  }
