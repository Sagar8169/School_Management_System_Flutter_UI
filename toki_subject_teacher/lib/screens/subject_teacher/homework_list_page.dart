...
class _HomeworkListPageState extends State<HomeworkListPage> {
  ...
  final List<Map<String, dynamic>> _allHomework = [
    {"id": 1, "title": "Chapter 5: Chemical Reactions", "class": "Class 9A", "subject": "Science", "status": "Active", "submissions": "28/42", "dueDate": "Nov 15, 2025", "assignedDate": "Nov 10, 2025", "description": "Complete all chemical equations from Chapter 5.", "attachments": 2},
    {"id": 2, "title": "Newton's Laws Problems", "class": "Class 8B", "subject": "Physics", "status": "Active", "submissions": "40/44", "dueDate": "Nov 12, 2025", "assignedDate": "Nov 8, 2025", "description": "Solve problems 1-20 from exercise section.", "attachments": 1},
    {"id": 3, "title": "Photosynthesis Lab Report", "class": "Class 10C", "subject": "Biology", "status": "Submitted", "submissions": "46/46", "dueDate": "Nov 10, 2025", "assignedDate": "Nov 5, 2025", "description": "Write a detailed lab report.", "attachments": 3},
    {"id": 4, "title": "Electricity Circuits", "class": "Class 9A", "subject": "Physics", "status": "Upcoming", "submissions": "0/42", "dueDate": "Nov 20, 2025", "assignedDate": "Nov 18, 2025", "description": "Draw circuit diagrams.", "attachments": 0},
    {"id": 5, "title": "Periodic Table Study", "class": "Class 8B", "subject": "Chemistry", "status": "Overdue", "submissions": "38/44", "dueDate": "Nov 5, 2025", "assignedDate": "Nov 1, 2025", "description": "Memorize first 20 elements.", "attachments": 1},
  ];
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Text("Homework List", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
          const Spacer(),
          GestureDetector(
  ...
  Widget _buildStatHub() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [_primaryPurple, const Color(0xFF4338CA)]),
        borderRadius: BorderRadius.circular(28),
        boxShadow: [BoxShadow(color: _primaryPurple.withOpacity(0.3), blurRadius: 20, offset: const Offset(0, 10))],
      ),
      child: Row(
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isSel ? _primaryPurple : Colors.grey.shade200),
              ),
              child: Center(
                child: Text(filters[i], style: TextStyle(color: isSel ? Colors.white : Colors.grey.shade600, fontWeight: FontWeight.w700, fontSize: 13)),
              ),
            ),
          );
        },
  ...
  Widget _buildHomeworkCard(Map<String, dynamic> hw) {
    Color statusCol;
    switch (hw['status']) {
      case 'Active': statusCol = Colors.blue; break;
      case 'Submitted': statusCol = Colors.green; break;
      case 'Upcoming': statusCol = Colors.orange; break;
      case 'Overdue': statusCol = Colors.red; break;
      default: statusCol = Colors.grey;
    }
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Expanded(child: Text(hw['title'], style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 16, color: Color(0xFF1E293B)))),
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                  decoration: BoxDecoration(color: statusCol.withOpacity(0.1), borderRadius: BorderRadius.circular(10)),
                  child: Text(hw['status'], style: TextStyle(color: statusCol, fontWeight: FontWeight.w800, fontSize: 10)),
                ),
              ],
            ),
            const SizedBox(height: 6),
            Text("${hw['class']} • ${hw['subject']}", style: const TextStyle(color: Colors.grey, fontSize: 13, fontWeight: FontWeight.w500)),
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 16),
                _hwIconInfo(Icons.calendar_today_rounded, "Due: ${hw['dueDate']}"),
                const Spacer(),
                if (hw['attachments'] > 0) Icon(Icons.attach_file_rounded, size: 16, color: _primaryPurple),
              ],
            ),
          ],
        ),
  ...
  Widget _hwIconInfo(IconData icon, String text) => Row(
    children: [
      ...
      Text(text, style: TextStyle(color: Colors.grey.shade600, fontSize: 11, fontWeight: FontWeight.w600)),
    ],
  );
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () => Navigator.pushNamed(context, SubjectTeacherRoutes.addHomework),
          ...
          child: const Row(
            ...
            children: [
              ...
              SizedBox(width: 8),
              Text("Assign New Homework", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w800)),
            ],
          ),
        ),
      ),
