...
class _StudentSearchPageState extends State<StudentSearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> filteredStudents = _students.where((student) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) => _buildModernStudentCard(filteredStudents[index]),
                    ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Expanded(child: Text("Search Students", style: TextStyle(color: Color(0xFF1E293B), fontSize: 18, fontWeight: FontWeight.bold))),
          GestureDetector(
  ...
  Widget _buildModernStudentCard(Map<String, dynamic> student) {
    ...
    final Color statusColor = isCritical ? const Color(0xFFEF4444) : const Color(0xFF10B981);
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.person_outline_rounded, color: statusColor, size: 24),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(student['name'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF1E293B))),
                        Text("${student['grade']} • ${student['id']}", style: TextStyle(color: Colors.grey.shade500, fontSize: 12)),
                      ],
                    ),
                  ),
                  Container(
                    ...
                    child: Text(student['status'], style: TextStyle(color: statusColor, fontWeight: FontWeight.bold, fontSize: 11)),
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  _miniStat("Avg Grade", "${student['avgGrade']}%", _getGradeColor(student['avgGrade'])),
                  _miniStat("Attendance", "${student['attendance']}%", _getAttendanceColor(student['attendance'])),
                ],
              ),
            ],
          ),
