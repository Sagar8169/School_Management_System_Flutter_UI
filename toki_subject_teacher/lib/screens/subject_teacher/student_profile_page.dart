...
// --- HEADER: COLOR & UI MATCHED TO YOUR EXAMPLE ---
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: _isCritical
              ? [const Color(0xFFB63C2E), const Color(0xFFD65747)]
              : [const Color(0xFF2FAE6C), const Color(0xFF4CC68A)],
            ...
            children: [
                  ...
                  children: [
                    Text(widget.studentData['name'].toString(),
                        style: const TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                    Text(
                        widget.studentData['details']?.toString() ??
                            'Not Specified',
                        style: const TextStyle(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10)),
                child: Text(_isCritical ? 'Critical' : 'Good',
                    style: const TextStyle(
                        color: Colors.white,
                        fontSize: 11,
                        fontWeight: FontWeight.bold)),
  ...
  Widget _buildHeroStat(String l, String v) =>
            ...
            children: [
              _buildStatValue(
                  ...
                  _isCritical
                      ...
                      : const Color(0xFF2FAE6C)),
              Container(width: 1, height: 40, color: Colors.black12),
              _buildStatValue('${widget.studentData['attendance']}%',
                  "Attendance", const Color(0xFFE67E22)),
            ],
          ),
          if (_isCritical) ...[
            ...
            Container(
              ...
              child: const Row(children: [
                ...
                Expanded(
                    child: Text(
                        "Requires Attention: Student performance is extremely below average.",
                        style: TextStyle(
                            color: Colors.red,
                            fontSize: 12,
            ...
            children: [
              ...
              TextButton(
                  onPressed: () => _navigateTo(
                      SubjectTeacherRoutes.gradesAnalytics,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _infoTile(Icons.person_rounded, "Parent Name", "Mr. Suresh Singh",
              const Color(0xFF2962FF)),
          const Divider(height: 24),
          _infoTile(Icons.phone_rounded, "Phone Number", "+91 98765 43210",
              const Color(0xFF2ECC71)),
          const Divider(height: 24),
          _infoTile(Icons.calendar_month, "Date of Birth", "March 15, 2010",
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          _btn("View Full Academic Report", Icons.analytics_outlined,
              const Color(0xFF2962FF), true, () {
            _navigateTo(SubjectTeacherRoutes.gradesAnalytics,
                arguments: {'studentData': widget.studentData});
          }),
          const SizedBox(height: 12),
          // ✅ REDIRECTS TO ATTENDANCE ANALYTICS
          _btn("View Attendance History", Icons.calendar_month_outlined,
              const Color(0xFF2962FF), false, () {
            _navigateTo(SubjectTeacherRoutes.attendanceAnalytics,
                arguments: {'studentData': widget.studentData});
          }),
          const SizedBox(height: 12),
          _btn("Contact Parent", Icons.call_outlined, const Color(0xFF2962FF),
              false, () {}),

          // ✅ SCHEDULE MEETING BUTTON (VISIBLE ONLY IF CRITICAL)
          if (_isCritical) ...[
            const SizedBox(height: 12),
            _btn("Schedule Parent Meeting", Icons.groups_outlined,
                const Color(0xFFDC2626), true, () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                      'Schedule meeting for ${widget.studentData['name']}'),
  ...
  Widget _btn(String t, IconData i, Color c, bool primary,
      ...
      SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            ...
            elevation: 0,
            side: BorderSide(
                color: primary ? Colors.transparent : c.withOpacity(0.3)),
            shape:
