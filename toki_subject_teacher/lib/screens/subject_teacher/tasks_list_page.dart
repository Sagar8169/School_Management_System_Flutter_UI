...
class _TasksListPageState extends State<TasksListPage> {
  ...
  final List<Map<String, dynamic>> _allTasks = [
    {
      ...
      "submissions": "44/44",
      "dueDate": "Nov 12, 2025",
      "description": "Grade all mid-term examination papers for Class 8B.",
    ...
    },
    {
      ...
      "submissions": "28/42",
      "dueDate": "Nov 15, 2025",
      "description": "Review the homework submissions for Chapter 5.",
    ...
    },
    {
      ...
      "submissions": "35/46",
      "dueDate": "Nov 18, 2025",
      "description": "Evaluation of the Biology Lab Report.",
      "assignedBy": "Mr. Vijay Prasad",
      "assigneeRole": "Science Teacher"
    },
    {
      ...
      "submissions": "0/44",
      "dueDate": "Nov 20, 2025",
      "description": "Prepare and upload the study guide.",
    ...
    },
    {
      ...
      "submissions": "42/42",
      "dueDate": "Nov 10, 2025",
      "description": "Final review of the semester science projects.",
      "assignedBy": "Mrs Raghini Sharma",
      "assigneeRole": "Class Teacher"
    },
  ];
  ...
  Widget _buildTaskItem(Map<String, dynamic> task) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.pushNamed(context, SubjectTeacherRoutes.taskDetails,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _iconLabel(
                    Icons.groups_outlined, "Subs: ${task['submissions']}"),
                _iconLabel(
                    Icons.calendar_today_outlined, "Due: ${task['dueDate']}"),
              ],
            )
          ],
        ),
  ...
  Widget _badge(String txt, Color bg, Color txtCol) => Container(
        ...
        child: Text(txt,
            style: TextStyle(
                color: txtCol, fontSize: 11, fontWeight: FontWeight.bold)),
      );
