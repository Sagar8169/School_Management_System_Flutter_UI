              ...
              child: RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    // Sample Data (Logic based on your original)
                    _buildTicketCard('TKT-001', 'Bus Maintenance', 'Oct 30, 2024', 'Pending', 'High', 'Engine overheating issue.'),
                    _buildTicketCard('TKT-002', 'Route Change', 'Oct 28, 2024', 'In Progress', 'Medium', 'Request to add Jubilee Hills stop.'),
                    _buildTicketCard('TKT-003', 'AC Repair', 'Oct 25, 2024', 'Resolved', 'High', 'AC cooling was very low.'),
      ...
      children: ['All', 'Pending', 'Resolved', 'Closed']
          ...
          child: ChoiceChip(
            ...
            labelStyle: TextStyle(
              color: _filterType == t ? Colors.white : Colors.black,
