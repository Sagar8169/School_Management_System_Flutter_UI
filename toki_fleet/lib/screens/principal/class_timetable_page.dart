    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildInfoCard(Icons.people_outline, 'Total Students', '${widget.classData['totalStudents']}'),
              const SizedBox(width: 12),
              _buildInfoCard(Icons.room_outlined, 'Room', widget.classData['room']),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              _buildInfoCard(Icons.layers_outlined, 'Floor', widget.classData['floor']), // Changed from Icons.floor_outlined
              const SizedBox(width: 12),
              _buildInfoCard(Icons.category_outlined, 'Section', widget.classData['section']),
            ],
          ),
        ],
      ),
