              ...
              children: [
                Container(
                  ...
                  child: Icon(request['icon'],
                      color: const Color(0xFF1D4ED8), size: 24),
                ),
              ...
              children: [
                Expanded(
                  child: _actionBtn(
                      ...
                      const Color(0xFFEF4444),
                      () => _processRequest(
                          request['id'], 'reject', request['name'])),
                ),
                ...
                Expanded(
                  child: _actionBtn(
                      ...
                      const Color(0xFF10B981),
                      () => _processRequest(
                          request['id'], 'approve', request['name']),
                      isPrimary: true),
                ),
              ],
            ),
        ...
        children: [
          ...
          const Text("All Caught Up!",
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w900,
                  color: Color(0xFF1E293B))),
          const Text("No pending approvals at the moment.",
              style: TextStyle(
