...
class _HomePrincipalState extends State<HomePrincipal> {
  ...
  void _openMoreSection(String sectionKey) {
    Navigator.pushNamed(
        context, PrincipalRoutes.morePage, arguments: {'section': sectionKey});
  }
...
// Vertical Divider
  ...
  Widget _premiumBadge() =>
      Container(
          ...
          child: const Text("Principal", style: TextStyle(
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.calendar_today_rounded, size: 16,
                        color: themeGreen),
                  ),
                  const SizedBox(width: 12),
                  const Text(
...
// Stats ke beech mein halki vertical line
  ...
  Widget _buildMainActions() {
    return Padding(
      ...
      child: Row(children: [
        Expanded(child: _ActionBox(title: "Take Attendance",
            sub: "Any Class",
        ...
        Expanded(child: _ActionBox(title: "Upload Grades",
            sub: "Any Class",
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.show_chart_rounded, size: 20,
                          color: Colors.blue),
                    ),
                ...
                _rowInsightUI(
                    Icons.trending_up_rounded, "Average Performance", "82%",
                    Colors.green, 0.82),
                const SizedBox(height: 18),
                _rowInsightUI(
                    Icons.analytics_outlined, "All Class Average", "78.5%",
                    Colors.blue, 0.78),
              ],
            ),
          ),
...
// --- UPDATED ROW INSIGHT WITH PROGRESS BAR ---
  Widget _rowInsightUI(IconData icon, String title, String value, Color color,
      double progress) {
    return Column(
      children: [
        Row(
...
// Analytics Insight Row Widget
  Widget _rowInsight(IconData icon, String label, String value,
      Color statusColor) {
    return Container(
...
// Modern Tile Helper
  Widget _buildModernApprovalTile(String label, String count, Color themeColor, IconData icon) {
    return Expanded(
      child: Container(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w900,
                      color: themeColor,
                      fontFamily: 'monospace'), // Monospace gives a data-heavy feel
                ),
              ],
            ),
...
// --- HELPER WIDGET: APPROVAL TILE ---
  Widget _buildApprovalTile(String label, String count, Color themeColor,
      IconData icon) {
    return Expanded(
      child: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    boxShadow: [
                      BoxShadow(color: themeColor.withOpacity(0.4),
                          blurRadius: 4,
                          spreadRadius: 1)
                    ],
                  ),
  ...
  Widget _buildTicketsCard() {
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30),
        child: InkWell(
          onTap: () => _openMoreSection('tickets'),
          child: Padding(
            padding: const EdgeInsets.all(22),
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(
                          Icons.confirmation_number_rounded, size: 20,
  ...
  Widget _ticketStatusRow(String label, String count, Color accentColor) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            accentColor == Colors.orange ? Icons.hourglass_top_rounded : Icons
                .fiber_new_rounded,
            size: 16,
            color: accentColor,
          ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _modernEventTile(
                  "25", "DEC", "Christmas Celebration", "School Auditorium",
              ...
              _modernEventTile(
                  "01", "JAN", "New Year Assembly", "Central Plaza",
...
// Helper: Calendar Style Event Tile
  Widget _modernEventTile(String day, String month, String title, String loc,
      Color themeColor) {
    return Row(
      children: [
        // Calendar Badge
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Icon(
                      Icons.location_on_outlined, size: 11, color: Colors.grey),
                  const SizedBox(width: 4),
                  Text(
                    venue,
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.local_shipping_rounded, size: 22,
                    ...
                    Container(
                      ...
                      child: const Icon(
                          Icons.arrow_forward_ios_rounded, size: 12,
                          color: Color(0xFF059669)),
                    ),
                  ],
                ),
...
// --- SUB-WIDGET: HARA STAT TILE ---
  ...
  Widget _buildSecondaryTools() {
    return Padding(
      ...
      child: Row(children: [
        Expanded(child: _ActionBox(title: "Manage Timetable",
            sub: "All Classes",
            icon: Icons.calendar_month_outlined,
        ...
        const SizedBox(width: 15),
        Expanded(child: _ActionBox(title: "Announcements",
            sub: "To Teachers",
  ...
  Widget _baseCard(
      {required String title, required IconData icon, required Color color, required Widget child, Widget? trailing, required VoidCallback onTap}) {
    return Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            Row(children: [
              ...
              const Spacer(),
              trailing ?? const Icon(
                  Icons.arrow_forward_ios, size: 12, color: Color(0xFFCBD5E1)),
            ]),
            const SizedBox(height: 20),
            child,
          ]),
  ...
  Widget _eventRow(String d, String t) =>
      Row(children: [
        Container(width: 50,
            padding: const EdgeInsets.all(6),
            decoration: BoxDecoration(color: const Color(0xFFF1F5F9),
                borderRadius: BorderRadius.circular(8)),
            child: const Icon(Icons.event, size: 16, color: themeBlue)),
        const SizedBox(width: 12),
  ...
  const _ActionBox({required this.title, required this.sub, required this.icon, required this.color, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(24), border: Border.all(color: Colors.black12), boxShadow: [BoxShadow(color: color.withOpacity(0.06), blurRadius: 20, offset: const Offset(0, 10))]),
        child: Column(children: [
          Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: color, borderRadius: BorderRadius.circular(16)), child: Icon(icon, color: Colors.white, size: 28)),
          const SizedBox(height: 12),
          Text(title, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: Color(0xFF1E293B))),
